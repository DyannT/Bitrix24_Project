...
class crest
{
    ...
    public static function installApp()
    {
        ...
        // Check if 'event' and 'auth' are set in the request
        ...
        // Check if 'PLACEMENT' is set for local installation
        elseif (isset($_REQUEST['PLACEMENT']) && $_REQUEST['PLACEMENT'] == 'DEFAULT') {
            ...
            // For local testing, set the settings manually
            // Replace with your actual credentials and tokens
            $result['install'] = static::setAppSettings(
                [
                    'access_token' => Cache::get('access_token'),
                    'expires_in' => 3600,
                    'application_token' => env('BITRIX24_APP_ID'),
                    'refresh_token' => Cache::get('refresh_token'),
                    'domain' => 'oauth.bitrix.info',
                    'client_endpoint' => 'https://b24-eadvxq.bitrix24.vn/rest/',
                ],
                true
            );
        }
